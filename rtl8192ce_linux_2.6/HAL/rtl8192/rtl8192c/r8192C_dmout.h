...
#ifndef	__HAL8192CPCIDM_OUT_H__
#define __HAL8192CPCIDM_OUT_H__
...
void DM_ChangeDynamicInitGainThresh(struct net_device *dev, u32 DM_Type, u32 DM_Value);
...
void dm_SW_AntennaSwitchCallback(unsigned long data);
#endif

...
#define IS_BOOT_FROM_EFUSE(dev)				(((struct r8192_priv*)rtllib_priv(dev))->epromtype == EEPROM_BOOT_EFUSE)
#define IS_BOOT_FROM_EEPROM_93C46(dev)		(((struct r8192_priv*)rtllib_priv(dev))->epromtype == EEPROM_93C46)
#define IS_BOOT_FROM_EEPROM_93C56(dev)		(((struct r8192_priv*)rtllib_priv(dev))->epromtype == EEPROM_93C56)
#define IS_MULTI_FUNC_CHIP(dev)				(((((struct r8192_priv*)rtllib_priv(dev))->MultiFunc) & (RT_MULTI_FUNC_BT|RT_MULTI_FUNC_GPS)) ? true : false)
#define IS_POLARITY_HIGH_ACTIVE(dev)		((((struct r8192_priv*)rtllib_priv(dev))->PolarityCtl) ? true : false)
